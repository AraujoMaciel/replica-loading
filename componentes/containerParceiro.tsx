        ...
        <div>
            <div className="sm:flex sm:flex-row sm:py-14 lg:flex lg:px-14 xl:w-10/12 xl:mx-auto">
                <div className="flex items-center gap-2 my-4 flex-col px-10 md:w-3/4 lg:w-8/12 lg:py-12 md:mx-auto xl:w-3/5 mx-auto text-center">
                    <h1 className="font-semibold text-lg md:text-xl lg:text-2xl"><span className="text-roxo font-bold">+</span> SOBRE NOSSOS</h1>
                    <h1 className="font-extrabold text-xl text-roxo md:text-2xl lg:text-4xl lg:font-black">CLIENTES E PARCEIROS</h1>
